    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted mt-1">{clients.length} total clients</p>
        </div>
      ...
      <div className="flex gap-3">
        ...
        <select className="bg-surface border border-border rounded-md px-4 py-2.5 text-sm focus:outline-none focus:border-gold">
          <option>All Packages</option>
          <option>Registration</option>
          <option>Publishing Admin</option>
          <option>Full Label</option>
        </select>
        <select className="bg-surface border border-border rounded-md px-4 py-2.5 text-sm focus:outline-none focus:border-gold">
